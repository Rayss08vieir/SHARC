        ...
        for bs in bs_active:
            ...
            if self.adjacent_channel:
                ...
                if self.param_system.adjacent_ch_emissions != "OFF":
                    ...
                    tx_oob = tx_oob[:, np.newaxis] - self.coupling_loss_oob_tx_inband_rx[active_beams, :][:, sys_active]
    ...
    def calculate_external_interference(self):
        ...
        for bs in bs_active:
            ...
            if self.adjacent_channel:
                ...
                # Out of band power
                if self.parameters.imt.adjacent_ch_emissions != "OFF":
                    tx_oob -= self.coupling_loss_oob_tx_inband_rx[ue, sys_active]

                if self.param_system.adjacent_ch_reception != "OFF":
                    rx_oob -= self.coupling_loss_imt_system_adjacent[ue, sys_active]
                # Out of band power
    ...
    def collect_results(self, write_to_file: bool, snapshot_number: int):
        ...
        for bs in bs_active:
            ...
            if self.parameters.imt.interfered_with:
                ...
                if len(self.system_imt_antenna_gain_adjacent):
                    self.results.system_imt_antenna_gain_adjacent.extend(
                        self.system_imt_antenna_gain_adjacent[np.ix_(sys_active, ue)].flatten(),)
